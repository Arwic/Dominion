...
namespace Dominion.Client
{
    ...
    public class Dominion : Game
    {
        public Dominion()
        {
            ...
            {
                new RichTextParseRule("population", ((char)FontSymbol.People).ToString(), Color.White, RichText.SymbolFont),
                ...
                new RichTextParseRule("science", ((char)FontSymbol.ConicalFlask).ToString(), Color.LightSkyBlue, RichText.SymbolFont),
                new RichTextParseRule("science_w", ((char)FontSymbol.ConicalFlask).ToString(), Color.White, RichText.SymbolFont),
                new RichTextParseRule("culture", ((char)FontSymbol.BookOpen).ToString(), Color.MediumPurple, RichText.SymbolFont),
                new RichTextParseRule("tourism", ((char)FontSymbol.Briefcase).ToString(), Color.White, RichText.SymbolFont),
                new RichTextParseRule("faith", ((char)FontSymbol.LightningBolt).ToString(), Color.White, RichText.SymbolFont),
                new RichTextParseRule("capital", ((char)FontSymbol.Star).ToString(), Color.White, RichText.SymbolFont),
                ...
                new RichTextParseRule("diplomacy", ((char)FontSymbol.Globe).ToString(), Color.White, RichText.SymbolFont),
                ...
                new RichTextParseRule("barchart", ((char)FontSymbol.BarGraph).ToString(), Color.White, RichText.SymbolFont),
                new RichTextParseRule("expand", ((char)FontSymbol.ArrowResize).ToString(), Color.White, RichText.SymbolFont),
                ...
                new RichTextParseRule("sight", ((char)FontSymbol.Eye).ToString(), Color.White, RichText.SymbolFont),
            };
